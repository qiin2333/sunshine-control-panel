...
export function m3ThemeFromSeed(seedArgb) {
  ...
  return {
    '--fd-accent': hexFromArgb(dark.primary),
    '--fd-accent-rgb': rgbVar(accent),
    '--fd-accent-secondary': hexFromArgb(dark.tertiary),
    '--fd-accent-secondary-rgb': rgbVar(accentSecondary),
    '--fd-bg-primary': hexFromArgb(neutral.tone(6)),
    '--fd-bg-primary-rgb': rgbVar(bgPrimary),
    '--fd-bg-secondary': hexFromArgb(neutral.tone(10)),
    '--fd-bg-secondary-rgb': rgbVar(bgSecondary),
    '--fd-bg-tertiary': hexFromArgb(neutral.tone(14)),
    '--fd-text-primary': hexFromArgb(dark.onSurface),
    ...
    '--fd-status-success': hexFromArgb(success),
    '--fd-status-success-rgb': rgbVar(statusSuccess),
    '--fd-status-warning': hexFromArgb(warning),
    '--fd-status-warning-rgb': rgbVar(statusWarning),
    '--fd-status-danger': hexFromArgb(danger),
